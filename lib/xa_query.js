...
XAQuery.prototype.begin = function(){
    this._conn.query("XA BEGIN ?", [this._txid]);
    return this;
}
XAQuery.prototype.end = function(){
    this._conn.query("XA END ?", [this._txid]);
    return this;
}
XAQuery.prototype.query = function(q,a,f){
    this._conn.query(q,a,f);
    return this;
}
